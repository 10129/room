...
databaseChangeLog(logicalFilePath: "com/jiao/xy99/db/liquibase.groovy") {
    ...
    migrationHelper.dbmigrate(dbType, ["com/jiao/xy99"], ["table", "data", "patch"])
